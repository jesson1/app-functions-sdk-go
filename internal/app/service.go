...
import (
	...
	"github.com/edgexfoundry/app-functions-sdk-go/v4/internal/bootstrap/handlers"
	...
	"github.com/edgexfoundry/app-functions-sdk-go/v4/internal/webserver"
...
func (svc *Service) LoadConfigurableFunctionPipelines() (map[string]interfaces.FunctionPipeline, error) {
	...
	for _, factory := range svc.configurableFactorMap {
		instance, err := factory(svc)
		if err != nil {
			return nil, fmt.Errorf("instantiate external configurable factory failed, %w", err)
		}
